...
abstract class Avram::Model
  ...
  macro table(table_name = nil)
    ...
    Avram::SaveOperationTemplate.setup({{ @type }})
    Avram::SchemaEnforcer.setup({{ @type }})
  end
  ...
  macro setup_column_names_method(type)
